 ...
 */
    make3() {
        ...
        this.head.nameEn = 'varycapsule';
        this.head.nameJa = this.head.nameEn;
        this.head.commentEn = `${d.toLocaleString()} CapsuleBuilder.make3`;
    ...
    // make3()
        {
            for (let i = 0; i < div / 4; ++i) { // 奥半球
                for (let j = 0; j <= div; ++j) {
                    ...
                    v.deformType = PMXVertex.DEFORM_BDEF4;
                    v.joints = [0, 0, 0, 0];
                    v.weights = [1, 0, 0, 0];
        ...
        {
            let name = 'tex/a003.png';
            this.textures.push(name);
        }

        for (let i = 0; i < 1; ++i) { // 材質 make3()
