 ...
 */
  ...
  make(param) {
...

    {
      ...
      const k = 0.25;
      const mens = [
        {p: [0, 1, 2, 3], n: [0, 0, -1], uv: [k * 2, k * 1, k * 3, k * 1, k * 2, k * 1, k * 3, k * 1,]},
        {p: [4, 0, 6, 2], n: [-1, 0, 0], uv: [k * 1, k * 1, k * 2, k * 1, k * 1, k * 1, k * 2, k * 1,]},
        {p: [1, 5, 3, 7], n: [1, 0, 0], uv: [k * 3, k * 1, k * 4, k * 1, k * 3, k * 1, k * 4, k * 1,]},
        {p: [4, 5, 0, 1], n: [0, 1, 0], uv: [k * 2, k * 1, k * 3, k * 1, k * 2, k * 1, k * 3, k * 1,]},
        {p: [2, 3, 6, 7], n: [0, -1, 0], uv: [k * 2, k * 1, k * 3, k * 1, k * 2, k * 1, k * 3, k * 1,]},
        {p: [5, 4, 7, 6], n: [0, 0, 1], uv: [k * 2, k * 1, k * 3, k * 1, k * 2, k * 1, k * 3, k * 1,]},
      ];
